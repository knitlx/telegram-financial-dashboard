...
START_TEXT = (
    ...
    "*Если нужно начать с текущих остатков:*\n"
    "Напиши простыми фразами, например:\n"
    "\"у меня сейчас 9400 бат\" или \"у меня 100 USD\"\n"
    "Я зафиксирую текущий баланс по валюте и дальше буду считать от него.\n\n"
